...
// @Component({
//   selector: 'int-phone-component',
//   templateUrl: './int-phone-component.component.html',
//   styleUrls: ['./int-phone-component.component.scss'],
// })
// export class IntPhoneComponentComponent implements OnInit {
//   constructor() {}
...
import { phoneNumberValidator } from './int-phone-component.validator';
...
@Component({
  ...
  styleUrls: [
    ...
    './int-phone-component.component.scss',
  ],
  providers: [
    CountryCode,
    {
      ...
      useExisting: forwardRef(() => IntPhoneComponentComponent),
      multi: true,
    },
    {
...
export class IntPhoneComponentComponent implements OnInit, OnChanges {
  ...
  @Input() selectedCountryCode = '+1';
  @Input() phoneValidation = true;
  @Input() inputId = 'phone';
  @Input() separateDialCode = false;
  @Input() phoneType: string[] = ['Mobile', 'Work', 'Other'];
  ...
  disabled = false;
  errors: any[] = ['Phone number is required.'];
  countrySearchText = '';
  ...
  public onPhoneNumberChange(): void {
    ...
    if (this.phoneNumber && typeof this.phoneNumber === 'object') {
      ...
      countryCode = this.getCountryCode(
        numberObj.countryCode ? numberObj.countryCode : numberObj.code
      ).iso2;
    }
    ...
    if (!this.value) {
      ...
      this.propagateChange({
        ...
        phoneType: this.selectedType,
      });
    }
  }

  public getCountryCode(countyDialCode) {
    const countryObj = this.allCountries.find(
      c => parseInt(c.dialCode) === parseInt(countyDialCode)
    );
    // const countryObj = this.allCountries.find(country => {
    //   parseInt(country.dialCode) === parseInt(countyDialCode);
    // });
    return countryObj;
  }
  ...
  writeValue(obj: any): void {
    ...
    this.selectedType = obj?.type ? obj?.type : this.phoneType[0];
    setTimeout(() => {
