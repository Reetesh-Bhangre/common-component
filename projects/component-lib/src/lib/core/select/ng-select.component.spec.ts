...
describe('NgSelectComponent', () => {
  ...
  describe('Model bindings and data changes', () => {
    ...
    it('should map label correctly', fakeAsync(() => {
      ...
      fixture.componentInstance.cities = [
        { label: 'Vilnius city', name: 'Vilnius' },
      ];
      tickAndDetectChanges(fixture);
      select = fixture.componentInstance.select;
    ...
    it('should escape label', fakeAsync(() => {
      ...
      const options =
        fixture.debugElement.nativeElement.querySelectorAll('.ng-option');
    ...
    it('should preserve latest selected value when items are changing', fakeAsync(() => {
      ...
      fixture.componentInstance.select.select(
        fixture.componentInstance.select.itemsList.items[1]
      );
      tickAndDetectChanges(fixture);
    ...
    it('should clear previous single select value when setting new model', fakeAsync(() => {
      ...
      const lastSelection: any =
        fixture.componentInstance.select.selectedItems[0];
    ...
    it('should clear disabled selected values when setting new model', fakeAsync(() => {
      ...
      fixture.componentInstance.selectedCities = <any>[
        fixture.componentInstance.cities[0],
        disabled,
      ];
      tickAndDetectChanges(fixture);
    ...
    it('should not add selected items to new items list when [items] are changed', fakeAsync(() => {
      ...
      fixture.componentInstance.selectedCities = [
        ...fixture.componentInstance.cities.slice(0, 2),
      ];
      tickAndDetectChanges(fixture);
      ...
      expect(internalItems[0].value).toEqual(
        jasmine.objectContaining({ id: 1, name: 'New city' })
      );
    }));
    ...
    it('should reset marked item when [items] are changed and dropdown is opened', fakeAsync(() => {
      ...
      expect(
        fixture.componentInstance.select.itemsList.markedItem.value
      ).toEqual({ name: 'Pabrade', id: 3 });
    ...
    it('should bind to nested label property', fakeAsync(() => {
      ...
      fixture.componentInstance.selectedCountry =
        fixture.componentInstance.countries[0];
      tickAndDetectChanges(fixture);
      expect(fixture.componentInstance.select.selectedItems).toEqual([
        jasmine.objectContaining({
          label: 'Lithuania',
      ...
      describe('single', () => {
        ...
        it('should apply host css classes', fakeAsync(() => {
          ...
          for (const c of classes) {
            expect(selectEl.classList.contains(c)).toBeTruthy(
              `expected to contain "${c}" class`
            );
          }
        ...
        it('should select by compareWith function when bindValue is not used', fakeAsync(() => {
          ...
          tickAndDetectChanges(fixture);
          expect(
            fixture.componentInstance.select.selectedItems[0].value
          ).toEqual(city);
        }));
  ...
  describe('Dropdown panel', () => {
    it('should set and render items in dropdown panel', fakeAsync(() => {
      ...
      fixture.componentInstance.cities = Array.from(Array(30).keys()).map(
        (_, i) => ({ id: i, name: String.fromCharCode(97 + i) })
      );
      tickAndDetectChanges(fixture);
      options =
        fixture.debugElement.nativeElement.querySelectorAll('.ng-option');
    ...
    it('should have div #padding with height other than 0 in dropdown panel when virtual scroll is enabled', fakeAsync(() => {
      ...
      expect(fixture.componentInstance.select.dropdownPanel.items.length).toBe(
        3
      );
      const options =
        fixture.debugElement.nativeElement.querySelectorAll('.ng-option');
    ...
    it('should scroll to selected item on first open when virtual scroll is enabled', fakeAsync(() => {
      ...
      const options =
        fixture.debugElement.nativeElement.querySelectorAll('.ng-option');
      const marked =
        fixture.debugElement.nativeElement.querySelector('.ng-option-marked');
    ...
    it('should select item with encapsulation = ShadowDom', fakeAsync(() => {
      ...
      expect(
        (<NgOption[]>fixture.componentInstance.select.selectedItems).length
      ).toBe(0);
      expect(fixture.componentInstance.select.isOpen).toBeFalsy();
  ...
  describe('Keyboard events', () => {
    ...
    describe('space', () => {
      ...
      it('should open empty dropdown if no items', fakeAsync(() => {
        ...
        triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Space);
        tickAndDetectChanges(fixture);
        const text = fixture.debugElement.query(By.css('.ng-option'))
      ...
      it('should open dropdown and mark first item', () => {
        ...
        triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Space);
        expect(select.itemsList.markedItem).toEqual(
          jasmine.objectContaining(result)
        );
      });
    ...
    describe('tab', () => {
      ...
      it('should mark first item on filter when tab', fakeAsync(() => {
        ...
        expect(fixture.componentInstance.select.itemsList.markedItem).toEqual(
          result
        );
        triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Tab);
        expect(fixture.componentInstance.select.selectedItems).toEqual([
  ...
  describe('Dropdown position', () => {
    it('should auto position dropdown to bottom by default', fakeAsync(() => {
      ...
      const selectClasses = (<HTMLElement>fixture.nativeElement).querySelector(
        '.ng-select'
      ).classList;
      const panelClasses = (<HTMLElement>fixture.nativeElement).querySelector(
        '.ng-dropdown-panel'
      ).classList;
    ...
    it('should auto position appended to body dropdown to bottom', fakeAsync(() => {
      ...
      const panelClasses =
        document.querySelector('.ng-dropdown-panel').classList;
      expect(select.dropdownPosition).toBe('auto');
      expect(selectClasses.contains('ng-select-bottom')).toBeTruthy();
      expect(panelClasses.contains('ng-select-bottom')).toBeTruthy();
      expect(selectClasses.contains('ng-select-top')).toBeFalsy();
  ...
  describe('Custom templates', () => {
    ...
    it('should clear item using value', fakeAsync(() => {
      ...
      fixture.componentInstance.select.clearItem(
        fixture.componentInstance.cities[0]
      );
      expect(fixture.componentInstance.select.selectedItems.length).toBe(0);
      tick();
    ...
    it('should display custom tag template', waitForAsync(() => {
      ...
      fixture.whenStable().then(() => {
        const template = fixture.debugElement.query(
          By.css('.tag-template')
        ).nativeElement;
    ...
    it('should display custom loading and no data found template', fakeAsync(() => {
      ...
      fixture.whenStable().then(() => {
        ...
        triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Space);
        tickAndDetectChanges(fixture);
        const loadingOption = fixture.debugElement.queryAll(
          By.css('.custom-loading')
        );
        ...
        triggerKeyDownEvent(getNgSelectElement(fixture), KeyCode.Space);
        tickAndDetectChanges(fixture);
        const notFoundOptions = fixture.debugElement.queryAll(
          By.css('.custom-notfound')
        );
  ...
  describe('Multiple', () => {
    ...
    describe('show selected', () => {
      ...
      it('should put unselected item back to list', fakeAsync(() => {
        ...
        expect(fixture.componentInstance.select.selectedItems.length).toBe(0);
        expect(
          fixture.componentInstance.select.itemsList.filteredItems.length
        ).toBe(3);
      }));

      it('should keep same ordering while unselecting', fakeAsync(() => {
        fixture.componentInstance.selectedCities = [
          ...fixture.componentInstance.cities.reverse(),
        ];
        tickAndDetectChanges(fixture);
        select.unselect(select.selectedItems[0]);
        select.unselect(select.selectedItems[0]);
  ...
  describe('Filter', () => {
    it('should filter using default implementation', fakeAsync(() => {
      ...
      expect(fixture.componentInstance.select.itemsList.filteredItems).toEqual(
        result
      );
    }));
    ...
    it('should toggle dropdown when searchable false', fakeAsync(() => {
      ...
      const selectInput = fixture.debugElement.query(
        By.css('.ng-select-container')
      );
      // open
    ...
    it('should not mark first item when isOpen is false', fakeAsync(() => {
      ...
      expect(
        fixture.componentInstance.select.itemsList.markedItem
      ).toBeUndefined();
    }));
    ...
    it('should filter grouped items', fakeAsync(() => {
      ...
      const filteredItems =
        fixture.componentInstance.select.itemsList.filteredItems;
    ...
    describe('with typeahead', () => {
      ...
      it('should not show selected city among options if it does not match search term', fakeAsync(() => {
        ...
        expect(
          fixture.componentInstance.select.itemsList.filteredItems[0]
        ).toEqual(
          jasmine.objectContaining({
      ...
      describe('search text', () => {
        it('should be visible until minTermLength reached', fakeAsync(() => {
          ...
          tickAndDetectChanges(fixture);
          expect(
            fixture.componentInstance.select.showTypeToSearch()
          ).toBeTruthy();
        }));
    ...
    describe('clear on add', () => {
      it('should clear search term by default', fakeAsync(() => {
        ...
        fixture.componentInstance.select.select(
          fixture.componentInstance.select.viewPortItems[0]
        );
    ...
    describe('edit search query', () => {
      it('should allow edit search if option selected & input focused', fakeAsync(() => {
        ...
        expect(
          fixture.componentInstance.select.editableSearchTerm
        ).toBeTruthy();
        const select = fixture.componentInstance.select;
      ...
      it('should display all items if wrong query passed & dropdown reopened', fakeAsync(() => {
        ...
        const firstOption = select.element.querySelector(
        ...
        input.dispatchEvent(new Event('input'));
        tickAndDetectChanges(fixture);
        const allOptions = select.element.querySelectorAll(
          '.ng-dropdown-panel .ng-option'
        );
        expect(allOptions.length).toEqual(
          fixture.componentInstance.cities.length
        );
      }));
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    beforeEach(fakeAsync(() => {
      ...
      comboBoxDiv = fixture.debugElement.query(
        By.css('.ng-input')
      ).nativeElement;
    }));
    ...
    it('should set aria-activedecendant equal to chosen item on open', fakeAsync(() => {
      ...
      expect(input.getAttribute('aria-activedescendant')).toBe(
        select.itemsList.markedItem.htmlId
      );
    }));
  ...
  describe('Output events', () => {
    ...
    it('should fire search event', fakeAsync(() => {
      ...
      expect(fixture.componentInstance.onSearch).toHaveBeenCalledWith({
        term: 'term',
        items: [],
      });
    }));
    ...
    it('should fire change when changed', fakeAsync(() => {
      ...
      fixture.componentInstance.selectedCityId =
      ...
      expect(fixture.componentInstance.selectedCityId).toBe(
    ...
    it('should fire addEvent when item is added', fakeAsync(() => {
      ...
      tickAndDetectChanges(fixture);
      fixture.componentInstance.select.select(
        fixture.componentInstance.select.itemsList.items[0]
      );
    ...
    it('should fire remove when item is removed', fakeAsync(() => {
      ...
      fixture.componentInstance.select.unselect(
        fixture.componentInstance.cities[0]
      );
      ...
      beforeEach(fakeAsync(() => {
        ...
        triggerMousedown = () => {
          ...
          control.triggerEventHandler(
            'mousedown',
            createEvent({ className: 'ng-control' })
          );
        };
      }));
    ...
    describe('clear icon click', () => {
      ...
      it('should clear model except disabled', fakeAsync(() => {
        ...
        expect(fixture.componentInstance.selectedCities[0]).toEqual(
          jasmine.objectContaining({ id: 2, name: 'Kaunas' })
        );
        expect(fixture.componentInstance.onChange).toHaveBeenCalledTimes(1);
      }));
  ...
  describe('Append to', () => {
    ...
    it('should append dropdown to custom selector', waitForAsync(() => {
      ...
      fixture.whenStable().then(() => {
        const dropdown = <HTMLElement>(
          document.querySelector('.container .ng-dropdown-panel')
        );
        expect(dropdown.style.top).not.toBe('0px');
        expect(dropdown.style.left).toBe('0px');
      });
  ...
  describe('Grouping', () => {
    ...
    it('should group items with children array by group key', fakeAsync(() => {
      ...
      expect(items[0].value).toEqual(
        jasmine.objectContaining({ country: 'United States' })
      );
      ...
      expect(items[3].value).toEqual(
        jasmine.objectContaining({ country: 'Argentina' })
      );

      expect(items[10].value).toEqual(
        jasmine.objectContaining({ country: 'Colombia' })
      );
      expect(items[11].parent).toBe(items[10]);
    }));
    ...
    it('should not group items without key', fakeAsync(() => {
      ...
      const items: NgOption[] =
        fixture.componentInstance.select.itemsList.items;
    ...
    it('Should have class ng-select and test', fakeAsync(() => {
      ...
      const elClasses: DOMTokenList = element.children[0].classList;
      const hasClass =
        elClasses.contains('ng-select') && elClasses.contains('test');
    ...
    it('should correctly update ng option selected property when groups map has undefined key', fakeAsync(() => {
      ...
      selectOption(fixture, KeyCode.ArrowDown, 0);
      expect(fixture.componentInstance.selectedAccount).toBe(
        'amalie@email.com'
      );

      select.filter('A');
      expect(nativeElement.querySelectorAll('.ng-option-selected').length).toBe(
        1,
        2
      );
      expect(select.viewPortItems.filter(opt => opt.selected).length).toBe(
        1,
        2
      );
...
function createTestingModule<T>(
  ...
  if (customNgSelectConfig) {
    TestBed.overrideProvider(NgSelectConfig, {
      useValue: customNgSelectConfig,
    });
  }
