...
const gridColumn = [
  ...
  },
  {
    ...
    field: 'eventTime',
    flex: 1,
    dateConverter: ['Europe/Vatican', 'DD-MM-YYYY, hh:mm:ss A'],
  },
  {
    headerName: 'Status',
    field: 'registered',
    flex: 1,
    resizable: false,
    cellRenderer: 'registerBtnRender',
    btnText: 'Register',
    spanText: 'Registered',
  },
];
...
export const withRegisterButton = TemplateDefault.bind({});
withRegisterButton.args = {};
